...
return [
	...
	'bookings' => [
		...
		'fields' => [
            ...
            'adult_nutrition_count' => 'Питание (кол-во)',
            'kids_nutrition_count' => 'Питание детей (кол-во)',
            'adult_breakfast'=>'Завтрак',
            'adult_lunch'=>'Обед',
            'adult_afternoon_tea'=>'Полдник',
            'adult_dinner'=>'Ужин',
            'kids_breakfast'=>'Детский завтрак',
            'kids_lunch'=>'Детский обед',
            'kids_afternoon_tea'=>'Детский полдник',
            'kids_dinner'=>'Детский ужин',
            'additional-information' => 'Дополнительная информация',
            'prepay_cache' => 'Предоплата наличными',
            'prepay_kaspi' => 'Предоплата kaspi',
            'prepay_eurasian' => 'Предоплата eurasian',
            'prepay_forte' => 'Предоплата forte',
            'post_pay_cache' => 'По факту наличными',
            'post_pay_kaspi' => 'По факту kaspi',
            'post_pay_eurasian' => 'По факту eurasian',
            'post_pay_forte' => 'По факту forte',
            'extra_pay_cache' => 'Доплата наличными',
            'extra_pay_kaspi' => 'Доплата kaspi',
            'extra_pay_eurasian' => 'Доплата eurasian',
